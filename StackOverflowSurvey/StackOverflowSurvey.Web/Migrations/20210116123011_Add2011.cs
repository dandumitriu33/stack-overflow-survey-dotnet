...
{
    public partial class Add2011 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PurchaseRecommendationInfluence = table.Column<string>(nullable: true),
                    ...
                    BudgetLess10K = table.Column<string>(nullable: true),
                    Budget10K25K = table.Column<string>(nullable: true),
                    Budget25K40K = table.Column<string>(nullable: true),
                    Budget40K75K = table.Column<string>(nullable: true),
                    Budget75K100K = table.Column<string>(nullable: true),
                    Budget100K150K = table.Column<string>(nullable: true),
                    BudgetMore150K = table.Column<string>(nullable: true),
                    BudgetDontKnow = table.Column<string>(nullable: true),
                    ...
                    TechProductOwnBluRay = table.Column<string>(nullable: true),
                    TechProductOwnHDTV = table.Column<string>(nullable: true),
                    TechProductOwnAppleTV = table.Column<string>(nullable: true),
                    TechProductOwnIPad = table.Column<string>(nullable: true),
                    TechProductOwnOtherNetbook = table.Column<string>(nullable: true),
